...
@Freezed()
abstract class CurrentGame with _$CurrentGame {
  @JsonSerializable(explicitToJson: true)
  const factory CurrentGame.entity({
  ...
  factory CurrentGame.fromJson(Map<String, dynamic> json) => _$CurrentGameFromJson(json);
}
